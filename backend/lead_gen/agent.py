...
class LeadResearchAgent:
    ...
    async def research_company(self, company_name: str, target_role: str):
        ...
        Write a highly personalized, professional cold email to a {target_role} at {company_name}.
        ...
        email_draft = self.llm.invoke(prompt).content
